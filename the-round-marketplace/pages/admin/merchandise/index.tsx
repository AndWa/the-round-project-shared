  ...
  return (
    <Stack align="flex-start">
      <NativeSelect
        ...
        description="You will manage merchandise for the selected event"
        radius="xs"
        required
      ...
      {selectedEvent && (
        <Button
          component={NextLink}
          href={`/admin/merchandise/create/${(selectedEvent as any)._id}`}
        >
      ...
      {selectedEvent && (
        <Paper sx={{ width: "100%" }} shadow="sm" p="md" withBorder>
          <Alert mb={16} icon={<AlertCircle size={32} />} title="Tickets">
            Once you create a merchandise you will not be able to delete it. You
            will also be required to sign a transaction with your <b>NEAR</b>{" "}
            wallet and pay a small fee.
          </Alert>
